(function($){
	...
	CherryJsCore.theme_script = {
		...
		smart_slider_init: function( self ) {
			$( '.bitunit-smartslider' ).each( function() {
				var slider = $(this),
		...
		swiper_carousel_init: function ( self ) {
			...
			jQuery('.bitunit-carousel').each( function() {
				var swiper = null,
		...
		subscribe_init: function( self ) {
			CherryJsCore.variable.$document.on( 'click', '.subscribe-block__submit', function( event ){
				...
				var $this       = $(this),
					...
					nonce      = form.find( 'input[name="bitunit_subscribe"]' ).val(),
		...
		main_menu: function ( self, target ) {
			...
			if ( 'undefined' !== typeof bitunit &&
				 'undefined' !== typeof bitunit.labels &&
				 'undefined' !== typeof bitunit.labels[ 'hidden_menu_items_title' ] &&
				 '' !== bitunit.labels.hidden_menu_items_title ) {
				 moreButtonText = bitunit.labels.hidden_menu_items_title;
			}
		...
		to_top_init: function ( self ) {
			if ( $.isFunction( jQuery.fn.UItoTop ) ) {
				$().UItoTop({
					text: bitunit.labels.totop_button,
					scrollSpeed: 600
				});
			}
		},
